...
통신 기술이 발달하면서 디지털 서비스의 교역은 거리의 제약을 덜 받게 되었을 것이라는 예상이 있다. 본 연구는 OECD-WTO BaTIS의 2010\~2023년 양자 서비스 교역 데이터를 사용해 EBOPS 2010 대분류 여덟 범주의 중력식을 PPML로 추정했다. 결과는 셋이다. 첫째, 먼 나라일수록 교역이 적어지는 정도, 곧 거리의 효과는 서비스 교역 전반에서 조금씩 줄어들고 있다. 운송과 여행을 포함해 여덟 범주 가운데 일곱에서 줄어드는 방향이다. 서비스 전체의 약화가 주로 거리에 덜 민감한 범주의 비중 확대에서 왔다는 Li et al. (2026)의 결과에 더해, 같은 범주 안에서 같은 수출국과 수입국 사이에서도 거리의 효과가 줄어들고 있다. 둘째, 디지털 서비스에서 거리의 효과가 더 빨리 줄어들지는 않았다. 통신 기술의 발달이 디지털 서비스의 전달 비용을 낮추므로, 이들 서비스에서는 화물이나 사람이 직접 이동해야 하는 운송과 여행보다 거리의 효과가 더 빨리 줄어들 것으로 예상할 수 있다. 그러나 통신·컴퓨터·정보를 포함한 어느 디지털 범주도 이 두 범주보다 유의하게 빨리 줄지 않았다. 유의한 차이는 오히려 예상과 반대 방향으로 나타났는데, 디지털 서비스인 금융에서는 운송, 여행과 달리 거리의 효과가 줄지 않았다. 셋째, 디지털 서비스라고 해서 거리의 영향을 덜 받는 것도 아니다. 디지털 서비스의 여섯 범주 모두 여행보다는 거리의 영향을 덜 받는다. 운송과 비교하면 유의하게 덜 받는 것은 지식재산권 사용료뿐이고, 통신·컴퓨터·정보는 운송보다 거리의 영향을 덜 받지 않는다.
...
서비스 교역은 이 질문을 다른 조건에서 던질 수 있게 한다. 서비스의 상당 부분은 국경을 넘는 물리적 이동 없이 통신망으로 전달되므로, 상품의 거리 효과를 설명하던 운송비의 몫이 작다. 통신 기술의 발달로 원격 공급 비용이 낮아진다면 그 효과는 디지털 전달 가능 서비스(이하 디지털 서비스)에서 먼저, 그리고 크게 나타나야 한다. Kimura and Lee (2006)는 OECD 10개국의 1999\~2000년 자료에서 서비스 교역이 상품 교역보다 중력식으로 더 잘 설명된다는 결과를 얻었다.

서비스 교역에서 거리 효과의 시간 변화를 범주별로 추정한 초기 연구로 Head et al. (2009)가 있다. 이들은 유로스탯의 1992\~2006년 양자 서비스 교역에 중력식을 추정해, 운송, 여행, 정부 서비스를 뺀 기타 상업서비스의 거리 효과가 1992년에는 상품보다 컸으나 상품보다 빠르게 줄었다고 보고했다. 두 연구의 설계는 세 가지에서 같다. 수출국×연도와 수입국×연도 고정효과를 넣어 각국의 규모와 다자간 저항을 흡수하고, 로그 거리에 선형 시간 추세를 곱한 항으로 거리 효과의 변화를 측정하며, 각국이 상대국별로 보고한 교역을 쓴다. 차이는 넷이다. 첫째, 자료와 기간이 다르다. 이들의 자료는 EU 27개국과 크로아티아, 일본, 노르웨이, 튀르키예, 미국 32개 보고국과 33개 상대국으로 이루어지고 2002년 이전에는 빈 곳이 많은 반면, 본 연구는 BaTIS에서 51\~58개 경제가 보고한 2010\~2023년의 교역을 쓴다. 둘째, 범주가 다르다. 이들은 총서비스와 기타 상업서비스, 그리고 그 안의 금융, 컴퓨터·정보, 기타 사업 서비스를 추정했지만 운송과 여행은 따로 추정하지 않았으므로, 디지털 서비스를 운송이나 여행과 같은 조건에서 비교하지 않았다. 본 연구는 운송과 여행을 비교 범주로 두고, 디지털 서비스 여섯 범주를 하나씩 비교 범주와 한 식에 넣어 차이를 검정한다. 셋째, 추정 방법이 다르다. 이들의 주 추정은 교역이 양수인 관측에 로그 선형 모형을 적용한 것이고, 0인 관측을 포함하는 준최우 추정은 고정효과가 많으면 수렴하지 않아 해마다 따로 추정하는 강건성 확인에만 썼다. 본 연구는 고차원 고정효과를 다루는 PPML(Correia et al., 2020)로 모든 연도를 한 식에 넣어 추정하고, 나라쌍 고정효과를 더해 보고되는 나라쌍의 구성 변화를 통제한다. 넷째, 통제변수가 다르다. 이들은 식민 관계와 공용어에 더해 법체계의 공통 기원과 시간대 차이를 넣었고, 본 연구는 BaTIS의 추정 모형과 같은 국경 인접, 공용어, 식민 관계를 쓴다. 두 연구의 결과는 III.2절에서 비교한다.

목적과 자료에서 본 연구와 가장 가까운 연구는 Li et al. (2026)이다. 이들은 BaTIS에서 추정값과 균형치를 빼고 보고치만 남긴 뒤 UNCTAD-WTO, 유로스탯, UN Comtrade 자료로 빈 곳을 메워 1985\~2023년의 서비스 교역 자료를 만들고, 해마다 수출국과 수입국 고정효과를 넣은 PPML로 서비스의 거리 탄력성을 추정했다. 서비스 전체의 거리 탄력성은 2000\~2004년 평균 -0.62에서 2020\~2023년 -0.50으로 약해졌고, 이들은 그 대부분을 거리에 덜 민감한 범주의 비중이 커진 구성 변화로 해석했다. 범주별 탄력성은 운송 -0.54, 여행 -0.73이 금융 -0.50, 통신·컴퓨터·정보 -0.37, 기타 사업 -0.35보다 컸다. 본 연구는 보고치만 쓴다는 점에서 이들과 같고 두 가지에서 다르다. 첫째, 이들은 범주 안의 변화를 범주 비중을 고정한 반사실로만 보였지만, 본 연구는 나라쌍 고정효과를 넣어 범주마다 같은 수출국과 수입국 사이의 추세를 직접 추정하고 그 유의성을 검정한다. 둘째, 이들은 범주별 탄력성을 나란히 보였지만, 본 연구는 디지털 범주와 비교 범주의 수준과 추세의 차이를 한 식에서 검정한다.
...
이 문제는 자료 구성에서 통제할 수 있다. BaTIS는 관측마다 그 값이 보고치인지 추정값인지를 방법론 코드로 밝히므로, 수출국이나 수입국 가운데 한쪽이라도 상대국별로 보고한 교역만 골라낼 수 있다. 본 연구는 Li et al. (2026)과 같이 이렇게 고른 2010\~2023년의 보고 표본을 쓰고, 이 표본으로 세 가지를 검증한다. 첫째, 범주별 거리 탄력성의 수준에서 디지털 서비스가 운송과 여행보다 거리에 덜 민감한가. 둘째, 같은 수출국과 수입국 사이에서 거리 탄력성이 2010년 이후 약해졌는가. 셋째, 그 변화가 디지털 서비스에서 비교 범주보다 빠른가.
...
표 2는 식 (1)을 범주별로 2010\~2023년 합동 추정한 결과다. 첫째와 둘째 열은 거리 탄력성 $\beta^{k}$와 그 표준오차이고, 나머지 세 열은 통제변수 계수다.
...
표 2의 통제변수는 BaTIS의 추정 모형과 같은 셋이다. Li et al. (2026)은 여기에서 식민 관계를 빼고 법체계의 공통 기원, 무역협정, EU 동반 가입을 더한 조합을 썼다. 같은 조합으로 식 (1)을 다시 추정하면 거리 탄력성의 절댓값은 여덟 범주 모두에서 작아진다. 가장 큰 몫은 EU 동반 가입이 설명하는데, 이 변수 하나만 더해도 절댓값이 범주에 따라 0.04\~0.07 줄어든다. EU 역내 교역은 거리가 짧고 교역이 많으므로 그 효과가 거리 계수에 섞여 있었던 것이다. 이 조합에서 운송(-0.533), 여행(-0.791), 금융(-0.560)은 Li et al. (2026)이 보고한 범주 평균(-0.54, -0.73, -0.50)과 가깝다. 반면 통신·컴퓨터·정보(-0.587)와 기타 사업(-0.475)은 그들의 -0.37과 -0.35보다 여전히 크고, 값을 균형치 대신 수출국 보고를 우선한 보고치로 바꾸어도 차이는 크게 줄지 않는다. 남은 차이는 그들이 UNCTAD-WTO와 UN Comtrade 자료를 더해 보고국과 기간을 넓힌 데서 올 수 있으나, 본 연구는 이를 확인하지 않았다.

이 조합에서 통신·컴퓨터·정보와 운송의 차이는 -0.054로 줄어 유의하지 않고($p$값 0.131), 개인·문화·여가의 차이 -0.087은 10% 수준에서만 유의하다($p$값 0.099). 지식재산권 사용료는 운송보다 유의하게 덜 민감하고(차이 0.198, $p$값 0.005), 여섯 디지털 범주가 모두 여행보다 유의하게 덜 민감하다는 결과도 유지된다. 따라서 통신·컴퓨터·정보가 운송보다 거리에 더 민감하다는 결과는 통제변수의 선택에 좌우되지만, 운송보다 덜 민감하지 않다는 결과는 두 조합에서 모두 성립한다.
...
표 3은 식 (3)의 연간 추세 $\theta^{k}$다. 첫째와 둘째 열은 추정치와 표준오차이고, 셋째 열은 그 값에 13을 곱한 2010\~2023년의 누적 변화다.
...
Li et al. (2026)은 서비스 전체의 거리 탄력성이 2000\~2004년 평균 -0.62에서 2020\~2023년 -0.50으로 약해진 것을 보이고, 범주별 비중을 2000\~2004년에 고정하면 약화가 작아지므로 그 대부분을 거리에 덜 민감한 범주의 비중 확대, 곧 구성 변화로 해석했다. 본 연구는 범주와 나라쌍을 고정한 채로도 운송과 여행에서 13년 동안 약 0.05, 통신·컴퓨터·정보에서 약 0.10의 약화를 측정했다. 두 연구는 기간, 표본, 추정 방식이 달라, 이 범주 내 약화가 그들의 구성 변화 해석과 어느 정도 양립하는지는 분해하지 않았다.
...
**표 4. 부분 표본과 통제변수별 거리 탄력성의 연간 추세(식 (3))**
...
무역협정과 EU 동반 가입을 통제해도 추세는 달라지지 않거나 오히려 뚜렷해진다. 금융을 제외한 일곱 범주가 양수이고, 그 가운데 운송, 여행, 보험·연금, 지식재산권 사용료, 통신·컴퓨터·정보, 기타 사업 여섯이 5% 수준에서 유의하며 개인·문화·여가는 10% 수준에서만 유의하다. 통신·컴퓨터·정보는 0.0075에서 0.0089로 커진다. 금융은 -0.0064로 5% 수준에서 유의한 음수가 되어, 이 범주에서는 거리의 효과가 줄지 않은 데서 나아가 강해졌다.
