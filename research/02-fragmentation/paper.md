...
표에서 보듯이 여행 한 범주가 서비스 전체의 블록 간 비중을 1.99%p 끌어내린다. 서비스 전체의 하락 0.84%p보다 큰데, 나머지 네 범주의 기여를 합하면 양수이기 때문이다. 여행은 블록 간 비중이 높은 범주인데 사후에 그 교역 비중이 줄었고 범주 안에서도 블록 간 비중이 내려갔다. ICT는 반대다. 범주 내 블록 간 비중이 21.56%에서 21.74%로 사실상 그대로인데 교역 비중이 커지면서 서비스 전체의 블록 간 비중을 0.63%p 끌어올렸다. 기타 디지털 서비스의 범주 내 효과도 -0.06%p에 그친다.
