...
결국 이 절의 분해는 서론에서 언급한 두 번째 가설을 지지하지 않는다. 절을 열며 세운 두 조건 가운데 어느 것도 성립하지 않는다. 서비스 전체의 하락은 디지털 범주가 아니라 여행에서 나왔고, 디지털로 전달되는 두 범주는 오히려 서비스 전체의 블록 간 비중을 0.93%p 끌어올렸으며, ICT의 블록 간 비중은 2018년 이후에도 내려가지 않았다.
