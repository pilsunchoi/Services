...
표에서 보듯이 서비스의 집약도는 두 기간 모두 1을 밑돌고 상품은 1 부근이다. 서비스에서는 블록을 넘는 교역이 두 블록의 몫만으로 기대되는 수준보다 적고, 상품에서는 그 수준과 거의 같다는 뜻이다. 이 차이는 거리와 언어처럼 국가쌍의 교역량을 좌우하는 요인, 그리고 여행처럼 공급자와 소비자가 같은 자리에 있어야 하는 범주의 몫과 관련된 것으로 보이나, 이 자료에는 그 요인들이 들어 있지 않아 확인할 수 없다.
