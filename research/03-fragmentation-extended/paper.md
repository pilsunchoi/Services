...
주: 합계 행의 구성 효과 -0.35%포인트와 범주 내 효과 -0.48%포인트가 앞의 표 2에 나온 서비스 전체의 변화 -0.84%포인트를 이룬다. 반올림한 두 값을 더하면 -0.83%포인트가 되어 0.01%포인트 어긋난다. 기타 디지털은 보험, 금융, 지식재산권 사용료, 기타 사업, 개인·문화·여가를 묶은 것이고, 기타는 가공, 수리, 건설, 정부다.\
